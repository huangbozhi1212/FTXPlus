...
import com.hbz.Exception.NotFoundException;
import com.hbz.dao.TagsRepository;
...
public class TagsServiceImpl implements TagsService {
    ...
    public List<Tag> listTag(String ids) {
        return tagsRepository.findAll(convertToList(ids));
    }
    ...
    @Transactional
    @Override
    public Tag updateTags(Long id, Tag type) {
