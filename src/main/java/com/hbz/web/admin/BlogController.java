...
import com.hbz.service.TypeService;
...
public class BlogController {
    ...
    @GetMapping("/blogs")
    public String listBlog(@PageableDefault(size = 5,sort = {"updateTime"}, direction = Sort.Direction.DESC)
    ...
    public String searchBlog(@PageableDefault(size = 5,sort = {"updateTime"}, direction = Sort.Direction.DESC)
                                   Pageable pageable, BlogQuery blog, Model model){
        model.addAttribute("page",blogService.listBlog(pageable,blog));
